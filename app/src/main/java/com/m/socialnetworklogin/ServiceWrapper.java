...
//            HttpLoggingInterceptor loggingInterceptor = new HttpLoggingInterceptor();
    ...
    // get place order api
    public Call<Registration> fbRegister(String securcode, String user_id, String email,  String username) {
        return mServiceInterface.register(convertPlainString(securcode),
                convertPlainString(user_id), convertPlainString(email), convertPlainString(username));
    }
